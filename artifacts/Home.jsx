    ...
    >
      <motion.div
        ...
        style={{
          ...
          background: SURF0, borderRadius: 16,
      ...
      >
        <div style={{
          ...
          borderBottom: '1px solid ' + BORDER, height: 52, flexShrink: 0,
        }}>
          <span style={{ fontSize: '0.75rem', fontWeight: 500, color: INK_SEC }}>{label}</span>
          <button
            onClick={onClose}
            aria-label="Close"
            style={{
              background: SURF2, border: '1px solid ' + BORDER,
              color: INK_BODY, width: 32, height: 32, borderRadius: '50%',
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 9999, padding: '0.65rem 1.25rem',
...
const capabilities = [
  {
    ...
    body: 'Mentoring the team infrastructure to make great design scalable — applying methodologies for recruiting, mentoring, structuring critique, and creating a culture where designers do their best work.',
  ...
  return (
    <main id="main-content">
      ...
      <section
        aria-label="Hero"
        style={{
          minHeight: '100svh', background: SURF0,
      ...
      >
        ...
        <div style={{ ...MAX, width: '100%' }}>
          ...
          {[
            { text: 'Strategy. Design. Builder.', color: INK, delay: 0.45 },
            { text: 'Excellence', color: BLUE, delay: 0.55, italic: true },
            ...
            <div key={text} style={{ overflow: 'visible', paddingBottom: '0.12em' }}>
              <motion.div
                ...
                style={{
                  ...
                  lineHeight: 1.0, letterSpacing: '-0.03em', color,
                  fontStyle: italic ? 'italic' : 'normal', fontWeight: 500,
                }}
              >{text}</motion.div>
            </div>
          ))}
            ...
            <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
              <button
                ...
                style={{
                  ...
                  padding: '0.75rem 1.5rem', background: 'transparent', cursor: 'pointer',
                  transition: 'all 0.25s', display: 'inline-flex', alignItems: 'center', minHeight: 44,
                }}
              ...
              <a
                ...
                style={{
                  ...
                  padding: '0.75rem 1.5rem', textDecoration: 'none', transition: 'background 0.25s',
          ...
          >
            <span style={{ fontSize: '0.55rem', textTransform: 'uppercase', letterSpacing: '0.15em', color: INK_TERT }}>See More</span>
      ...
      <section aria-label="About" style={{ background: SURF0, padding: SP }}>
        <div style={{ ...MAX, display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 'clamp(2rem,5vw,5rem)', alignItems: 'start' }}>
          ...
          <div>
            ...
            <FadeUp delay={0.12}>
              <p style={{ fontSize: '0.95rem', color: INK_BODY, lineHeight: 1.7, marginBottom: '1.5rem' }}>
                I partner with founders, product leaders, and engineering teams to turn ambiguous problems into clear product direction — and then into shipped experiences that move the metrics that matter.
              </p>
            </FadeUp>
            <FadeUp delay={0.2}>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', alignItems: 'center' }}>
                ...
                <button
                  onClick={() => go(setPage, 'about')}
                  style={{
                    fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.12em', fontWeight: 600,
                    color: INK_SEC, background: 'transparent', border: 'none', cursor: 'pointer', padding: '0.5rem',
                  }}
        ...
        <div style={MAX}>
          <FadeUp>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'clamp(2rem,4vw,3.5rem)', flexWrap: 'wrap', gap: '1rem' }}>
              <div>
                <p style={{ fontSize: '0.6rem', textTransform: 'uppercase', letterSpacing: '0.15em', color: INK_TERT, marginBottom: 8, fontWeight: 600 }}>Team and Product Building</p>
      ...
      <section aria-label="Contact" style={{ background: SURF1, padding: SP, borderTop: '1px solid ' + BORDER }}>
        <div style={{ ...MAX, display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 'clamp(2rem,5vw,5rem)', alignItems: 'center' }}>
          <FadeUp>
            <p style={{ fontSize: '0.6rem', textTransform: 'uppercase', letterSpacing: '0.15em', color: INK_TERT, fontWeight: 600 }}>Communication is Key</p>
          </FadeUp>
          <FadeUp delay={0.1}>
